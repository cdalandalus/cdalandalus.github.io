...
if (file_exists($target_file)) {
 ...
 //Check file size
if ($_FILES["fileToUpload"]["size"] > 8000000) {		// if ($_FILES["fileToUpload"]["size"] > 500000) {
...
$body ="<h2><strong><u>Presentación de la tesis registrada – 31 Congreso Internacional INGEGRAF 2022 </u></strong></h2><br><br>".
	
	
	
	"<strong>Información registrada:</strong><br>".
	"<br><strong>Nombre:</strong> " . $nombre . 
	"<br><strong>Apellidos:</strong> " . $apellidos . 
	"<br><strong>Institución-Empresa:</strong> " . $compania . 
	"<br><strong>Teléfono:</strong> " . $telefono . 
	"<br><strong>Correo Electrónico:</strong> " . $correo.
	...
	"<br><br> Si necesita hacer una consulta de la información enviada, le ruego acceda al siguiente enlace, https://31congreso.ingegraf.uma.es/form-verificar-abstract.php. Deberá identificarse con el correo-e utilizado y la contraseña remitida en este correo-e de confirmación." .
	"<br><br>Para cualquier consulta, puede contactar con el comité organizador enviando un correo-e a 31congreso.ingegraf@uma.es <br><br>Gracias por su participación. Un cordial saludo. <br>Comité Organizador <br> 31 Congreso Internacional INGEGRAF <br><br>31congreso.ingegraf.uma.es<br>31congreso.ingegraf@uma.es";
...
try {
    ...
    $mail->Subject = 'II Premio Tesis Ingegraf – 31st INGEGRAF International Conference';
    $mail->Body    = $body;
	$mail->CharSet ='UTF-8';
