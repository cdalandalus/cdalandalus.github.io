...
$body = "<strong><u>Registered information / Información registrada</u>:</strong>" .
        ...
        "Estimado/a usuario/a,<br>en breve recibirá una respuesta a la consulta realizada.<br>Un cordial saludo.";
...
try {
    ...
    //Recipients
    $mail->setFrom('josem@uma.es', 'Al-andalus');
	$mail->addAddress($correo, 'Al-andalus');               //Name is optional
    ...
    $mail->Subject = 'Consulta desde la Web Al-andalus';
    $mail->Body    = $body;
	$mail->CharSet ='UTF-8';
...
if($error_email == 0){
		...
		echo '<script>
			window.location.replace("https://alandalus-torremolinos.on.drv.tw/web/");
			</script>';		
	}	
